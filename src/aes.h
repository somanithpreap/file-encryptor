...
const uint8 InvSBOX[16][16] = {{0x52, 0x09, 0x6a, 0xd5, 0x30, 0x36, 0xa5, 0x38,
...
const uint8 MIXCOL_MATRIX[4][4] = {{2, 3, 1, 1}, 
                                   {1, 2, 3, 1}, 
                                   {1, 1, 2, 3}, 
                                   {3, 1, 1, 2}};
const uint8 InvMIXCOL_MATRIX[4][4] = {{0xe, 0xb, 0xd, 0x9},
                                      ...
                                      {0xd, 0x9, 0xe, 0xb},
                                      {0xb, 0xd, 0x9, 0xe}};
const uint8 Rcon[10][4] = {{0x01, 0x00, 0x00, 0x00},
                           {0x02, 0x00, 0x00, 0x00},
                           {0x04, 0x00, 0x00, 0x00},
                           {0x08, 0x00, 0x00, 0x00},
                           {0x10, 0x00, 0x00, 0x00},
...
private:
  State state;
  uint8 key[32]; 
  uint8 round_key[60][4]; //All of the round keys are in there.

public:
  AES(uint8 in[16], uint8 key[32]);
  void key_expansion(uint8 key[32]);
  void update(uint8 in[16]);
